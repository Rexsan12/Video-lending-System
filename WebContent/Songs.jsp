  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
          ...
          <img src="images/badmadill.jpg" alt="">
          <h4>Badtameez dil</h4>
          <p></p>
          ...
          <img src="images/raanjana.jpg" alt="">
          <h4>Raanjana</h4>
          <p></p>
          ...
          <img src="images/senorita.jpg" alt="">
          <h4>Senorita</h4>
          <p></p>
    ...
    <%
        ...
        try {
            ...
            psmt = con.prepareStatement("select * from video_lend where category='Song'");
