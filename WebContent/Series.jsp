  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
          ...
          <img src="images/breaking%20bad.jpg" alt="">
          <h4>Badtameez dil</h4>
          <p></p>
          ...
          <img src="images/stranger%20things.jpg" alt="">
          <h4>Breakup Song</h4>
          <p></p>
          ...
          <img src="images/sacred%20games.jpg" alt="">
          ...
          <img src="images/walikingdead.jpg" alt="">
          <h4>Senorita</h4>
          <p></p>
    ...
    <%
        ...
        try {
            ...
            psmt = con.prepareStatement("select * from video_lend where category='Series'");
